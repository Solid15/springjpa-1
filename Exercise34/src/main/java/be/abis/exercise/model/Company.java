...
public class Company {
	...
	@Id
	@SequenceGenerator(name="company_generator", sequenceName="companies_cono_seq", allocationSize=1)
	...
	@OneToMany(targetEntity = Person.class, mappedBy = "company", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
