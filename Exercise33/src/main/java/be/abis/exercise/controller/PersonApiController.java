...
public class PersonApiController {
    ...
    @PostMapping(path="")
    public Person addPerson(@RequestBody Person p) throws PersonAlreadyExistsException {
    ...
    @PutMapping("{id}")
    public Person changePassword(@PathVariable("id") int id, @RequestBody Person person) throws PersonNotFoundException {
